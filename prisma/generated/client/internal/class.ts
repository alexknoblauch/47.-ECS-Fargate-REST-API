...
const config: runtime.GetPrismaClientConfig = {
  ...
  "inlineSchema": "// prisma/schema.prisma\ngenerator client {\n  provider = \"prisma-client\" // In v7: \"prisma-client\", nicht \"prisma-client-js\"!\n  output   = \"./generated/client\" // WICHTIG: output muss definiert sein!\n}\n\ndatasource db {\n  provider = \"postgresql\" // oder mysql, sqlite, etc.\n  // url NICHT hier! Die kommt in prisma.config.ts\n}\n\nmodel User {\n  id    Int     @id @default(autoincrement())\n  email String  @unique\n  name  String?\n}\n",
  "runtimeDataModel": {
    "models": {},
    "enums": {},
    "types": {}
